...
int main ()
{
 ...
 volatile R_ODR *ODR=(volatile R_ODR*) (0x40010800 +0x0c);
 *(volatile unsigned long int*) (0x40021000 +0x18) |=1<<2;
 *(volatile unsigned long int*) (0x40010800 +0x04) &=0xff0fffff;
 *(volatile unsigned long int*) (0x40010800 +0x04) |=0x00200000;
 while(1)
 {
  int i;
  ODR->bits.p_13=1;
