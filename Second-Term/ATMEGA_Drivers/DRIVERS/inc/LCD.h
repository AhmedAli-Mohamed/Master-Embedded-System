...
#define LCD_CTRLPORT     GPIOB          //GPIOX , X can be (A....D)
#define LCD_RS		      (1)           //choose pin to connected register selected pin in lcd
#define LCD_RW			  (2)			//choose pin to connected read & write pin in lcd
#define LCD_EN         	  (0)			//choose pin to connected enable pin in lcd
